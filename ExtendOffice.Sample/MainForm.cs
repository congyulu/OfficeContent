...
namespace ExtendOffice.Sample
{
    public partial class MainForm : Form
    {
        ...
        private void ShowContent(IOfficeFile file)
        {
            ...
            else if (file is PowerPointFile)
            {
                PowerPointFile pptFile = file as PowerPointFile;
                this.tbInformation.Text = pptFile.AllText;
            }
            else if (file is PowerPointOOXMLFile)
            {
                PowerPointOOXMLFile pptFile = file as PowerPointOOXMLFile;
                this.tbInformation.Text = pptFile.AllText;
            }
            else
            {
        ...
        private void asposeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Aspose.Words.Document doc = new Document(this.dlgOpen.FileName);
            tbInformation.Text = doc.PageCount.ToString();
        }
    }
}